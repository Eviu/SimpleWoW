...
Namespace World
	Public Enum WorldCommand As UInteger
		MSG_NULL_ACTION = 0
		CMSG_BOOTME = 1
		CMSG_DBLOOKUP = 2
		SMSG_DBLOOKUP = 3
		...
		''' bool unk
		''' </summary>
		CMSG_INSTANCE_LOCK_WARNING_RESPONSE = 319
		' 3.2.2 updated
		CMSG_UNUSED2 = 320
		...
		'''     ulong guid2
        '''     if ((guid2.HighPart AND 0xF0400000) != 0) // if its not a player and not a pet
		'''     {
		'''         int str2Len
		...
		''' {
		'''     ulong guid2
        '''     if ((guid2.HighPart AND 0xF0000000) != 0)
		'''     {
		'''         int str1Len
		'''         byte[str1Len] str1Data
		'''     }
...
'         * 
		...
		''' int eventFlags
        ''' if ((eventFlags AND CalendarEventFlags.GuildAnnouncement) == 0)
		''' {
		'''     int count
		'''     for (count)
		'''     {
        ...
        ''' int id [ if (id AND 0x80000000) do nothing]
		''' pguid creator?
		...
		''' int64 itemGuid
		''' </summary>
		CMSG_UNKNOWN_1204 = 1204
		' prolly info request, somesort
		''' <summary>
		''' int64 itemGuid
		''' int response
		''' if (response)
		...
		UMSG_UNKNOWN_1219 = 1219
		' not found
		UMSG_UNKNOWN_1220 = 1220
		' not found
		UMSG_UNKNOWN_1221 = 1221
		' not found
		UMSG_UNKNOWN_1222 = 1222
		' not found
		''' <summary>
		...
		CMSG_UNKNOWN_1231_ACK = 1231
		' ack of 1230
		SMSG_UNKNOWN_1232 = 1232
		CMSG_UNKNOWN_1233_ACK = 1233
		' ack of 1232
		...
		''' }
		''' </summary>
		CMSG_USE_EQUIPMENT_SET = 1237
		' moved in 3.2.2, prev. 1227
		''' <summary>
		''' byte result (0 = ok, 4 = bags full, > 0 = error)
		''' </summary>
		SMSG_USE_EQUIPMENT_SET_RESULT = 1238
		' moved in 3.2.2, prev. 1228
		' manu unks...
		...
		' lua: GMReportLag
		UMSG_UNKNOWN_1283 = 1283
		' not found
		UMSG_UNKNOWN_1284 = 1284
		' not found
		UMSG_UNKNOWN_1285 = 1285
		' not found
		SMSG_UNKNOWN_1286 = 1286
		' ERR_CORPSE_IS_NOT_IN_INSTANCE = 0x1A8,
		UMSG_UNKNOWN_1287 = 1287
		' not found
		CMSG_UNKNOWN_1288 = 1288
		' lua: SetAllowLowLevelRaid
		CMSG_UNKNOWN_1289 = 1289
		' lua: SetAllowLowLevelRaid
		SMSG_CAMERA_SHAKE = 1290
		' uint32 SpellEffectCameraShakes.dbc index, uint32
		SMSG_UNKNOWN_1291 = 1291
		' some item update packet?
		UMSG_UNKNOWN_1292 = 1292
		' not found
		SMSG_REDIRECT_CLIENT = 1293
		' uint32 ip, uint16 port, uint32 unk, uint8[20] hash
		CMSG_UNKNOWN_1294 = 1294
		' something with networking
		SMSG_UNKNOWN_1295 = 1294
		'
		CMSG_UNKNOWN_1296 = 1295
		' something with networking
		SMSG_UNKNOWN_1297 = 1296
		'
		CMSG_UNKNOWN_1298 = 1297
		' something with networking
		UMSG_UNKNOWN_1299 = 1298
		' not found
		SMSG_COMBAT_LOG_MULTIPLE = 1299
		' SMSG, multi combatlog
		SMSG_LFG_OPEN_FROM_GOSSIP = 1300
		' event EVENT_LFG_OPEN_FROM_GOSSIP (opens dungeon finder, probably for outdoor bosses)
		SMSG_UNKNOWN_1302 = 1301
		' something with player movement (move event 58?)
		CMSG_UNKNOWN_1303 = 1302
		' something with player movement (move event 58?)
		SMSG_UNKNOWN_1304 = 1303
		' something with player movement (move event 58?), speed packet
		UMSG_UNKNOWN_1305 = 1304
		' not found
		UMSG_UNKNOWN_1306 = 1305
		' not found
